...
WebUI.setText(findTestObject('Object Repository/AddNewUnitRepo/Page_/input__name'), 'زجاجة')

WebUI.click(findTestObject('Object Repository/AddNewUnitRepo/Page_/button__1_2'))

WebUI.verifyElementText(findTestObject('AddNewUnitRepo/Page_/li_addUnitNoNameAdded'), 'اسم الوحدة مطلوب')
