...
WebUI.setText(findTestObject('Object Repository/AddNewUnitRepo/Page_/input__name'), 'ExistUnitTest')
...
WebUI.verifyElementText(findTestObject('AddNewUnitRepo/Page_/li_addUnitNoNameAdded'), 'اسم الوحدة موجود مسبقا')
